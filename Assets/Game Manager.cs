...
public class GameManager : MonoBehaviour
{
    ...
    private float turnDelay = 0.1f;                          //Delay between each Player turn.
    private int playerFoodPoints = 100;                      //Starting value for Player food points.
    ...
    [HideInInspector] private bool playersTurn = true;       //Boolean to check if it's players turn, hidden in inspector but public.
